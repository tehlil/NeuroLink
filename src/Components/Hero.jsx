import { curve, heroBackground, robot } from "../assets (3)/assets"
...
const Hero = () => {
  ...
  return (
    ...
    crosses
    crossesOffset="lg:translate-y-[5.525rem]"
    customPaddings
    id="Hero"
    >
        ...
        <div className="aspect-[33/40] rounded-b-[0.9erem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]" >
        <img 
        src={robot}
