...
import Arrow from "../assets (3)/assets/svg/Arrow"
import {GradientLight} from './design/design/Benefits'
import ClipPath from "../assets (3)/assets/svg/ClipPath"
...
const Benefits = () => {
  return (
   <Section id="features">
    ...
    key={item.id}
    >
    <div  className="relative z-5 flex flex-col min-h-[22rem] p-[2.4rem] pointer-events-none">
